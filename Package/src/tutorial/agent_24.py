...
# For get class name
def get_entry_point():
    return 'Agent_24' # Change this to match your class name below

class Agent_24(AutonomousAgent):
    ...
    def run_step(self, input_data, timestamp):
        ...
        control.throttle = 1.0      # A scalar value to control the vehicle throttle [0.0, 1.0]. Default is 0.0.
