...
class HumanAgent(AutonomousAgent):
    ...
    # {'type': 'sensor.lidar.ray_cast', 'x': 0.45, 'y': -0.4, 'z': 2.15, 'roll': 0.0, 'pitch': 0.0, 'yaw': -45.0, 'id': 'LIDAR'}
    # {'type': 'sensor.other.radar', 'x': 0.45, 'y': -0.4, 'z': 2.15, 'roll': 0.0, 'pitch': 0.0, 'yaw': -45.0, 'fov': 30, 'id': 'RADAR'}
    # {'type': 'sensor.other.gnss', 'x': 0.45, 'y': -0.4, 'z': 2.15, 'id': 'GPS'}
    # {'type': 'sensor.other.imu', 'x': 0.45, 'y': -0.4, 'z': 2.15, 'roll': 0.0, 'pitch': 0.0, 'yaw': -45.0, 'id': 'IMU'}
